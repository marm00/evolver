    ...
    useEffect(() => {
        ...
        game.createGame("singlecell").then((gameState) => {
            ...
            const handleMouseDown = (_: MouseEvent) => {
                ...
                game.attack(gameState.player.mousePosition, gameState.player, gameState.world, gameState.oRectPool, gameState.v2Pool, gameState.v2Pool2, gameState.spearPool, gameState.spears);
            }
